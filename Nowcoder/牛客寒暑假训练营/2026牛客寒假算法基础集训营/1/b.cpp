...
signed main()
{
	...
	while(T --)
	{
		...
		// int Ma = *max_element(a.begin(), a.end()), ma = *min_element(a.begin(), a.end());
		// int Mb = *max_element(b.begin(), b.end()), mb = *min_element(b.begin(), b.end());
		// if(Ma < mb || ma > Mb)
		// {
		// 	cout <<comb._fac[n] <<endl;
		// 	continue;
		// }
		...
		cout <<comb._fac[s] * comb._fac[n - s] <<endl;
	}
	return 0;
}
