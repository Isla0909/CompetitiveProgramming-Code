...
signed main()
{
	...
	while(T --)
	{
		...
		SegmentTree seg1(a), seg2(b);

		auto check = [&](int l, int r) -> bool
		{
			if(a[1] > r || a[1] < l || b[n] > r || b[n] < l) return false;
			//cout <<l <<" l and r " <<r <<endl;
			int idx1 = seg1.find_first(1, 1, n, l, r);
			//cout <<idx1 <<endl;
			int idx2 = seg2.find_last(1, 1, n, l, r);
			if(idx1 == -1) idx1 = n;
			else idx1 --;
			if(idx2 == -1) idx2 = 1;
			else idx2 ++;
